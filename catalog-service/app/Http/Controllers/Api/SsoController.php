...
class SsoController extends Controller
{
    #[OA\Get(
        ...
        responses: [
            ...
            new OA\Response(response: 401, description: 'Unauthorized — missing or invalid Bearer token')
        ]
    )]
    ...
    #[OA\Post(
        ...
        responses: [
            ...
            new OA\Response(response: 401, description: 'Token is invalid or expired')
        ]
    )]
